...
export default function GetStartedCode() {
  ...
  return (
    <div className="lg-pr:5 mt-6 inline-flex items-center gap-4 rounded-full bg-gray-900 px-4 py-2 font-mono text-sm text-white shadow-xl md:py-4 md:whitespace-nowrap lg:pl-6 lg:text-base">
      <span>
